...
- 首页与结果页已完成一轮重构：统一 App Shell、收紧文案、减少解释性小字
- 视觉方向已切换为“可信数据感”：暖白底、深石墨主色、低饱和强调色
- 首页当前重点是“直接查目标”，结果页当前重点是“概览 / 风险信号 / 失败经验 / 同校参考 / 下一步”
- `skip-link` 已改为默认隐藏，仅键盘聚焦时显示；首页标题与 Hero 文案字号已收小一档
